# graphiti Doramagic Pack for AI Coding Agents

Pack version: `v1.0.0` · Last updated: `2026-07-11`

[![Pack v1.0.0](https://img.shields.io/badge/pack-v1.0.0-blue)](./CHANGELOG.md)
[![License](https://img.shields.io/github/license/tangweigang-jpg/doramagic-graphiti-pack)](./LICENSE)
[![Issues](https://img.shields.io/github/issues/tangweigang-jpg/doramagic-graphiti-pack)](https://github.com/tangweigang-jpg/doramagic-graphiti-pack/issues)

Languages: English | [中文](./README.zh-CN.md)

Agent memory is not a text dump; Graphiti makes the update and retrieval policy part of the system contract.

This is an independent AI context resource pack for getzep/graphiti: host instructions, prompt preview, evals, pitfalls, and recovery rules you can load into Claude Code, Codex, Cursor, Aider, and other AI coding agents.

> This is an independent capability pack. It is not affiliated with or endorsed by getzep/graphiti unless explicitly stated.
...
## getzep/graphiti Pitfalls and Recovery

Start with `03_PITFALL_LOG.md` when setup, permissions, runtime behavior, or verification fails.

## Source Attribution

This project pack was assembled by [Doramagic](https://doramagic.ai) to make getzep/graphiti usable as a portable AI capability asset.

- Upstream/source: https://github.com/getzep/graphiti
- License: Apache-2.0
- Pack contents: prompts, host instructions, checks, guardrails, and validation notes
- Relationship: independent pack; not affiliated with or endorsed by getzep/graphiti unless explicitly stated
