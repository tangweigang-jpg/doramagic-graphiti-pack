...
Use this pack to help an AI coding agent work with `getzep/graphiti` safely and verifiably.

## When To Use

- The user wants `give AI coding hosts a source-backed Graphiti memory workflow with graph updates, backend choices, retrieval checks, and contradiction boundaries`.
