...
Description: Graphiti Agent Memory Pack AI context pack for Claude Code, Codex, Cursor, and Aider: verify graph updates, retrieval, and contradiction handling with getzep/graphiti.

Homepage: https://doramagic.ai/en/projects/graphiti/
...
Discussions: disabled by default; enable only after real engagement appears.
